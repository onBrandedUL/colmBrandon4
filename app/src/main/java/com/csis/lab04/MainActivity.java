...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Switch audioPlaybackOnOff = (Switch) findViewById(R.id.audioPlaybackOnOff);
        myCounter = (TextView) findViewById(R.id.counter);
        myCounter1 = (TextView) findViewById(R.id.counter1);
        slider1 = (SeekBar) findViewById(R.id.slider_1);
        slider2 = (SeekBar) findViewById(R.id.slider_2);
        ...
        slider2.setOnSeekBarChangeListener(
                new SeekBar.OnSeekBarChangeListener() {
                    ...
                    public void onProgressChanged(SeekBar seekBar, int progress,
                        ...
                        sendFloatPD("slider1", slide2Value);
                    }
        ...
        /*audioPlaybackOnOff.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked1){
                float val1 = (isChecked1) ? 1.0f :0.0f;
                sendFloatPD("apOnOff", val1);
            }
